...
//{"Callid":"393814798","Dni":"8657929461","Cli":"9326145839","agent":"8657970967","Status":"onCallConnect"}
...
if ($data['Status'] !== 'onCallConnect') {
    sendResponse(400, 'Invalid Status. Expected onCallConnect');
}

logRequest('on-call-connected', $data);
...
if (!$bitrixResult['success']) {
    sendResponse(
        502,
        'Failed to save call connected data into Bitrix',
...
sendResponse(
    200,
    'Call connected data received successfully',
    [
        'Callid' => $data['Callid'],
